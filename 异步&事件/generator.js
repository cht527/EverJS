...
function* getFullName(familayName,l){
    console.log('名字生成中...');
    var fullName=yield generatorName(familayName,l);
    return fullName

}
var familayName='cao';
var get_name=getFullName(familayName,15);

get_name.next().value.then(function(data){
    console.log(data)
}).catch(function(err){
    console.log(err)
})
